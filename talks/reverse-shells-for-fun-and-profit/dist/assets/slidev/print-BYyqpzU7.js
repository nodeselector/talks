import{d,Y as p,I as _,o as a,b as l,e as t,x as s,z as r,F as u,X as h,Z as f,l as v,g}from"../modules/vue--2rrS9jf.js";import{k as b,c as m,f as x,t as y,b as N}from"../index-BQcGyKHg.js";import{N as k}from"./NoteDisplay-RRJlHaAY.js";import"../modules/shiki-BQ1XKe-f.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},D={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},z=t("div",{class:"flex-auto"},null,-1),C={key:0,class:"border-main mb-8"},F=d({__name:"print",setup(M){p(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
